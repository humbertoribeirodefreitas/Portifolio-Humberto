...
const Hero = () => {
  const [content, setContent] = useState({
    titulo: 'Humberto Ribeiro de Freitas',
    descricao: 'Especialista em desenvolvimento de sistemas e soluções tecnológicas sob demanda. Foco em criar aplicações robustas, lojas virtuais e sistemas personalizados com excelência técnica e atendimento 100% home office.',
    avatar: '/hto1.png',
  });
  ...
  useEffect(() => {
    try {
      ...
      if (data) {
        ...
        setContent({
          titulo: parsed.titulo || 'Humberto Ribeiro de Freitas',
          descricao: parsed.descricao || 'Especialista em desenvolvimento de sistemas e soluções tecnológicas sob demanda. Foco em criar aplicações robustas, lojas virtuais e sistemas personalizados com excelência técnica e atendimento 100% home office.',
          avatar: typeof parsed.avatar === 'string' && parsed.avatar ? parsed.avatar : '/hto1.png',
        });
      }
    } catch (e) {
      setContent({
